...
\paragraph{So geht es:} Einen Kreis bilden. Reihum nennt jede einen Spruch wie "`Ich bin der jubelnde Julian"' oder "`Ich bin die singende Sabine"': Das Adjektiv soll also mit dem gleichen Buchstaben (oder Laut) beginnen wie der eigene Vorname. Dazu macht die Spielerin eine passende Geste oder Bewegung. Wer dran ist, wiederholt die vorherigen Sprüche und Bewegungen, bevor sie den eigenen bringt~-- ganz ähnlich dem Spiel \emph{Kofferpacken}.
